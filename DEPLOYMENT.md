...
| `SENDGRID_API_KEY` | Yes | SendGrid API key for OTP / password-reset emails |
| `SENDGRID_FROM_EMAIL` | Yes | Verified sender address in SendGrid |
...
| OTP emails not sending | Wrong env var name | Must be `SENDGRID_API_KEY` and `SENDGRID_FROM_EMAIL` |
